...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports {btn_incSobel}]
//U
...
//R
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports {btn_decSobel}]
//D
##Pmod Header JA
set_property -dict { PACKAGE_PIN J1   IOSTANDARD LVCMOS33 } [get_ports {light_sensor}];#Sch name = JA1
...
#create_clock -period 40.00 -name cam_pclk -waveform {0.000 20.584} -add [get_ports i_cam_pclk]
create_clock -period 41.667 -name cam_pclk -waveform {0.000 20.833} -add [get_ports i_cam_pclk]
