...
module pp_preprocess 
    ...
    output wire [10:1]  o_fill,  //
    output wire o_almostempty,
    output wire o_valid  // new signal indicating valid output data
    );
...
// Assign o_valid based on whether the output FIFO is empty
